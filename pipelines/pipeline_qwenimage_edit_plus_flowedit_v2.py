...
class QwenImageEditPlusPipeline(DiffusionPipeline, QwenImageLoraLoaderMixin):
    ...
    def __call__(
        ...
        Args:
            image_src (`torch.Tensor`, `PIL.Image.Image`, `np.ndarray`):
                Source image to be edited. This is the image that will be transformed according to the prompt.
            image_tgt (`torch.Tensor`, `PIL.Image.Image`, `np.ndarray`):
                Target reference image used as visual guidance for the text prompt encoding.
            prompt (`str` or `List[str]`, *optional*):
        ...
        # Process target image for VLM condition
        img_tgt = image_tgt
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # Use analytical velocity field: v = d/dt[(1-t)*x_src + t*noise] = noise - x_src
                ...
                # 3. Compute velocity field difference
